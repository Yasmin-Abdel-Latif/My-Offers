...
$(document).ready(function() {
	...
	String startDateGiven = (String) ITDLServletUpdateOffer.offerChosen.getStartDate();
	%>
...
<div class="home" style="width: 100%; overflow: auto;">
	...
	<div style="position: absolute; left: 30%; right: 10%; top: 20%;">
		<div ALIGN="center">
			<form action="ITDLServletUpdateOffer" id="offerform" method="post">
				<font size="4" color="#ffffff" face="Lucida Calligraphy">
					<b>
						Start Date : 
					</b>
				</font>
				<input name="datepickerStart" id="datepickerStart" value="<%=ITDLServletUpdateOffer.offerChosen.getStartDate()%>" style="margin-right: 20px;"/>
				<font size="4" color="#ffffff" face="Lucida Calligraphy">
					<b>
						End Date   : 
					</b>
				</font>
				<input name="datepickerEnd" id="datepickerEnd" value="<%=ITDLServletUpdateOffer.offerChosen.getEndDate()%>" style="margin-right: 20px;"/>
				<br>
				<select name='category' required>
	                 <option selected="selected" value="<%=ITDLServletUpdateOffer.offerChosen.getCategoryID()%>"><%=ITDLServletUpdateOffer.offerChosen.getCategoryID()%></option>
	             ...
	             <br>
	             <textarea name="offerContent" rows="7" cols="50" id="offerUpdatedContent" class="offerContent"><%=ITDLServletUpdateOffer.offerChosen.getContent()%></textarea>
	             <br>
	             <input type="submit" class="doneAdding" value="Done">
	             <input type="hidden" name="StoreID" value="<%=storeEmail%>">
	             <input type="hidden" name="OfferID" value="<%=ITDLServletUpdateOffer.offerChosen.getOfferID()%>">
			</form>
